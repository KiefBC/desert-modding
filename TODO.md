...
**Unblocked 2026-09-24** by the build-25477059 re-target: both tools' calibration is re-pinned to
572 lists / 895 blocks / 13447 records and `gen-collect-names` verifies against the plugin's dump
with no banner (`docs/findings/2026-09-24-build-25477059-retarget.md`). Nothing below is done yet.
...
re-target, because the `items` tool it extends refuses the current table until then. (The re-target
landed 2026-09-24; `items` runs clean on 25477059.)
