{
  description = "Crimson Desert mods - desert-core + the Desert Looter / Desert Gatherer / Desert Overlay ASI plugins (Rust, cross-compiled to Windows x64)";
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "  just build      release build of the three plugins"
