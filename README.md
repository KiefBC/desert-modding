...
| --- | --- | --- |
| [desert-tooling](desert-tooling) | 0.9.0 | Auto-loot, gathering yields and the in-game menu, in one plugin |
...
- **Dispatch** (`[Dispatch]`, `[dispatch]`) — faster dispatch missions, bigger
  mission rewards, a dump of both into the log, and a read-only buff/stat
  census (`[buffs]`).
...
- **Desert Tooling**: [desert-tooling-v0.9.0](https://github.com/KiefBC/desert-modding/releases/tag/desert-tooling-v0.9.0)
- **Desert Gatherer (DMM pack)**: [desert-gatherer-dmm-v1.2](https://github.com/KiefBC/desert-modding/releases/tag/desert-gatherer-dmm-v1.2)
