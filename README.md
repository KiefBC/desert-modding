...
| --- | --- | --- |
| [desert-tooling](desert-tooling) | 0.7.0 | Auto-loot, gathering yields and the in-game menu, in one plugin |
...
- **Desert Tooling**: [desert-tooling-v0.7.0](https://github.com/KiefBC/desert-modding/releases/tag/desert-tooling-v0.7.0)
